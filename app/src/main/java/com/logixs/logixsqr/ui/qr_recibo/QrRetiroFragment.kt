package com.logixs.logixsqr.ui.qr_recibo
...
class QrRetiroFragment : Fragment() {

    private val PERMISSION_CAMARA_REQUEST_CODE: Int = 100
    val operacionActual = "retiro"
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_qr_retiro, container, false)
            ...
            PERMISSION_CAMARA_REQUEST_CODE -> {
                ...
                if ((grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED)
                    ...
                    requireActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.nav_host_fragment, QrRetiroFragment())
                        .commit();
                } else {
    ...
    private fun obtenerInfoML(view: View, qrModel: QrModel) {
        ...
        val stringRequestML = StringRequest(
            ...
            Response.Listener<String> { mlResponse ->
                ...
                procesarRespuestaML(view, qrModel, mlResponse)
            },
            Response.ErrorListener {
                ...
                habilitarEscaneo()
                Dialogs.mostrarErrorVolley(context, lyt_container)
            }
        )
    ...
    private fun procesarRespuestaML(view: View, qrModel: QrModel, mlResponse: String?) {
